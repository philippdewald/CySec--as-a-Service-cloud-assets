...
ais-security.de
    ...
    Check if \verb|website.zoom.us| or \verb|website-TLD.zoom.us| exists.
    
    Or search for subdomains of \verb|.zoom.us| using \url{https://searchdns.netcraft.com/} or \url{https://pentest-tools.com/information-gathering/find-subdomains-of-domain} for more subdomains (nearly all when doing a "Full Scan"?; output can be saved in PDF to work as a DB?)
